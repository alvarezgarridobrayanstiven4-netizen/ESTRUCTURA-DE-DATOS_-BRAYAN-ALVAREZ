//3. Sensor de Temperatura (Control de Calidad) Una máquina industrial 
// registra la temperatura cada 10 minutos y guarda los datos en un arreglo. 
...
public class Ejercicio3 {
    public static void main(String[] args) {
        ...
        double[] temperaturas = {35.5, 37.2, 40.1, 38.6, 39.9};
        ...
        System.out.println("La temperatura más alta fue: " + max);
    }
}